...
Dll :
      ...
      <div class="text-right mb-5">
        <button class="btn btn-app" id="save" style="position: absolute;right: 872px;">Tambah Request Kajian</button>
      </div>
</div>
...
dataAll = ({
  ...
  console.log(dataAll);
  $.ajax({
  url: "/api/add/request/kajian",
  type: "POST",
  data:  dataAll,
  success:function(data){
  location.href="/request_kajian";
  console.log(data);
  }
  });
});
