...
<div class="container-app">
	...
	<div class="form-group" style="position: relative;top: 16px;">
		...
		<div class="alert" style="width: 415px; position: relative;left: 32%; top: 14px; background-color: #f8f8f8; border-color: #f8f8f8; "><strong style="font-size: 14px; ">Terima kasih untuk para donatur yang sudah mempercayakan donasi nya kepada kami.
		Dan terima kasih sudah menggunakan website kami sebagai media penyaluran donasi anda</strong>
		</div>
@endsection