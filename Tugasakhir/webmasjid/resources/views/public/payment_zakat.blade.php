	...
	<div id="stepper3" class="bs-stepper vertical">
		<div class="bs-stepper-header">
			<div class="step" data-target="#test-lv-1">
				...
				width: 50rem;">
				<strong style="position: relative;left: 46rem;bottom: 2rem;">Rp 100.0000.123</strong>
			...
			<div class="step" data-target="#test-lv-2" style="    position: relative;bottom: 6rem;">
				...
				<hr class="ln1" style="position: relative;left: 4rem;bottom: 2rem;width: 50rem;"><em style="    position: relative;left: 8%;bottom: 3rem;">Anda bisa transfer via apapun (m-banking, atm dll) ke</em></div><div class="line"></div>
