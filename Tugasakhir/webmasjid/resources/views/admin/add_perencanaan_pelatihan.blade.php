...
<div id="formAdd">
	...
	<div class="content-admin">
      ...
      <div class="col pr-0">
        <input type="" name="" id="Alamat" placeholder="Judul Perencanaan" class="form-control" style="max-width: 25rem">
      </div>
    </div>
    ...
    <div class="row m-0 mb-3">
      <div class="col p-0 pt-2 font-14 text-bold" style="max-width: 14rem">Pemateri yang akan di undang</div>
...
<div class="text-right mb-5">
 <button class="btn btn-app" id="save">Tambah Perencanaan</button>
</div>
</div>
</div>
