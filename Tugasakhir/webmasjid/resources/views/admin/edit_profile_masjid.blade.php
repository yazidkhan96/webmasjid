   ...
   <!--  <form action="{{url('admin/upload/masjid')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="content-admin">
      <div class="row m-0 mb-3">
        ...
        <div class="col pr-0">
        <input type="" value="{{$masjid->nama_masjid}}" id="namamasjid"  placeholder="Nama Masjid" class="form-control" style="max-width: 25rem">
      </div>
    </div>
    <div class="row m-0 mb-3">
      ...
      <div class="col pr-0">
        <input type="" value="{{$masjid->alamat_masjid}}" id="alamatmasjid"  placeholder="Alamat Masjid" class="form-control" style="max-width: 25rem">
      </div>
    </div>
    <div class="row m-0 mb-3">
      ...
      <div class="col pr-0">
        <input type="" id="tahunberdiri" placeholder="Tahun Berdirinya Masjid" class="form-control" style="max-width: 25rem" value="{{$masjid->tahun_beridiri}}">
      </div>
    </div>
    <div class="row m-0 mb-3">
      ...
      <div class="col pr-0">
        <div class="row m-0">
          <img  src="{{asset('images/Masjid')}}/{{$masjid->gambar}}" class="edit-img">
...
<script type="text/javascript">
  $('#desc').summernote('code','{!!$masjid->deskripsi!!}');
var fileImg = [];
var dataAll = [];
...
/*  if(statusForm == 0){
    ...
    console.log(dataAll);
    $.ajax({
      url: '/api/admin/update/masjid/'+'{{$masjid->id}}',
      type: "POST",
      data:  dataAll,
